...
class ToastView {
  ...
  static void createView(
      String msg, BuildContext context, int type, int duration, int gravity, Color background, Color textColor, double backgroundRadius) async {
...
class ToastWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Positioned(top: gravity == 2 ? 50 : null, bottom: gravity == 0 ? 50 : null, child: widget);
  }
}
