...
WCApproveSessionResponse _$WCApproveSessionResponseFromJson(Map<String, dynamic> json) => WCApproveSessionResponse(
      approved: json['approved'] as bool? ?? true,
      chainId: json['chainId'] as int?,
      accounts: (json['accounts'] as List<dynamic>).map((e) => e as String).toList(),
      publicKeys: (json['publicKeys'] as List<dynamic>).map((e) => e as String).toList(),
